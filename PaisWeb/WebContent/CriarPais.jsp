        ...
        <form action="controller.do" method="post">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" name="populacao" id="populacao" placeholder="População">
                </div>

                <div class="form-group col-md-6">
                    <label for="email">Área</label>
                    <input type="number" class="form-control" name="area" id="area" placeholder="Área">
                </div>
            </div>
            <hr />
